...
local function init_runtime_counters()
  ...
  _G.v12_non2xx_debug_count = 0
  _G.v12_debug_non2xx_enabled = debug_non2xx and 1 or 0
end
...
local function record_non2xx_debug(st, status, body, conn_id)
  ...
  local idx = (_G.v12_non2xx_debug_count or 0) + 1
  _G.v12_non2xx_debug_count = idx
  _G["v12_non2xx_debug_line__" .. tostring(idx)] = line
end
...
function done(summary, latency, requests)
  ...
  for _, t in ipairs(threads) do
    local count = t:get("v12_non2xx_debug_count") or 0
    for i = 1, count do
      local line = t:get("v12_non2xx_debug_line__" .. tostring(i))
