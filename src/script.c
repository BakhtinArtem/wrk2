...
void script_request(lua_State *L, char **buf, size_t *len, uint64_t conn_id) {
    int pop = 1;
...
void script_response(lua_State *L, int status, buffer *headers, buffer *body, uint64_t conn_id) {
